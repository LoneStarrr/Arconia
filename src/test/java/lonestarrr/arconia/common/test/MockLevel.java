...
/**
 * A lightweight {@link SimplifiedLevel} implementation backed by a {@link HashMap} for unit
 * testing. Returns AIR for any position that hasn't been explicitly set.
 */
