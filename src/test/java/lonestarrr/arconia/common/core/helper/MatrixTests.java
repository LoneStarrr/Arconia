...
public class MatrixTests {
    ...
    void testGetRotatedCoordinate(
            Vec3i coordinate, final int matrixWidth, final int matrixHeight,
            final int rotationCount, final Vec3i expectedCoordinate) {
        Vec3i rotatedCoordinate = Matrix.getRotatedCoordinate(coordinate, matrixWidth, matrixHeight, rotationCount);
    ...
    static Stream<Arguments> testGetRotatedCoordinate_Parameters() throws Throwable {
        return Stream.of(
                ...
                Arguments.of(new Vec3i(0, 10, 0), 3, 4, 1, new Vec3i(3, 10, 0)),
                Arguments.of(new Vec3i(0, 10, 3), 3, 4, 1, new Vec3i(0, 10, 0)),
                // 2..3 rotations
                Arguments.of(new Vec3i(0, 10, 3), 3, 4, 2, new Vec3i(2, 10, 0)),
                Arguments.of(new Vec3i(0, 10, 3), 3, 4, 3, new Vec3i(3, 10, 2)),
                // No [effective] rotation => no change
                Arguments.of(new Vec3i(0, 10, 3), 3, 4, 0, new Vec3i(0, 10, 03)),
                Arguments.of(new Vec3i(0, 10, 3), 3, 4, 4, new Vec3i(0, 10, 03))
        );
    }
}
