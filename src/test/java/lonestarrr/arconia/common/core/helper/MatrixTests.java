...
public class MatrixTests {
  ...
  @ParameterizedTest(
      name = "Run {index}: coordinate={0}, width={1}, height={2}, rotations={3} expected={4}")
  ...
  void testGetRotatedCoordinate(
      ...
      final Vec3i expectedCoordinate) {
    Vec3i rotatedCoordinate =
        Matrix.getRotatedCoordinate(coordinate, matrixWidth, matrixHeight, rotationCount);
