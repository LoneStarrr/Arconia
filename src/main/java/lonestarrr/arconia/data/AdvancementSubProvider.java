...
public class AdvancementSubProvider
    implements net.minecraft.data.advancements.AdvancementSubProvider {
  @Override
  public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver) {
    ...
    ItemStackTemplate rootIconTemplate =
        guideBookEmpty
            ? new ItemStackTemplate(ModItems.fourLeafClover.get(), 1)
            : guideBookTemplate;
    ItemPredicate.Builder rootCriterion =
        guideBookEmpty
                        ...
                        .exact(
                            DataComponentExactPredicate.allOf(
                                DataComponentMap.builder()
                                    .set(
                                        PatchouliHelper.patchouliGuideBookComponent(),
                                        ResourceLocationHelper.prefix("guide_book"))
                                    .build()))
                        .build());
    AdvancementHolder root =
        Advancement.Builder.advancement()
            .addCriterion(
                "guide_book", InventoryChangeTrigger.TriggerInstance.hasItems(rootCriterion))
            .display(
                rootIconTemplate,
    ...
    AdvancementHolder pedestal =
        Advancement.Builder.advancement()
            .addCriterion(
                "pedestal",
                InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.pedestal.asItem()))
            .parent(root)
            .display(
    ...
    AdvancementHolder centerPedestal =
        Advancement.Builder.advancement()
            .addCriterion(
                "center_pedestal",
                InventoryChangeTrigger.TriggerInstance.hasItems(ModBlocks.centerPedestal.asItem()))
            .parent(root)
            .display(
    ...
    AdvancementHolder fourLeafClover =
        Advancement.Builder.advancement()
            .addCriterion(
                "four_leaf_clover",
                InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.fourLeafClover))
            .parent(root)
            .display(
    ...
    AdvancementHolder cloverStaff =
        Advancement.Builder.advancement()
            .addCriterion(
                "clover_staff",
                InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.cloverStaff))
    ...
    AdvancementHolder redBranchOfEssence =
        Advancement.Builder.advancement()
            .addCriterion(
                "red_branch_of_essence",
                InventoryChangeTrigger.TriggerInstance.hasItems(
                    ModItems.getColoredBranch(RainbowColor.RED)))
    ...
    AdvancementHolder redEssence =
        Advancement.Builder.advancement()
            .addCriterion(
                "red_arconium_essence",
                InventoryChangeTrigger.TriggerInstance.hasItems(
    ...
    AdvancementHolder potOfGold =
        Advancement.Builder.advancement()
            .addCriterion(
                "pot_of_gold",
                ModCriteriaTriggers.CREATE_POT_OF_GOLD_TRIGGER
                    .get()
                    .createCriterion(new PotOfGoldTrigger.TriggerInstance(Optional.empty())))
            .parent(cloverStaff)
            .display(
                Items.GOLD_BLOCK,
    ...
    AdvancementHolder touchGrass =
        Advancement.Builder.advancement()
            .addCriterion(
                "touch_grass",
                ModCriteriaTriggers.TOUCH_GRASS_TRIGGER
                    .get()
                    .createCriterion(new TouchGrassTrigger.TriggerInstance(Optional.empty())))
            .parent(redBranch)
            .display(
    ...
    AdvancementHolder orangeSapling =
        Advancement.Builder.advancement()
            .addCriterion(
                "orange_arconium_tree_sapling",
                InventoryChangeTrigger.TriggerInstance.hasItems(
            ...
            .display(
                ...
                Component.translatable(
                    "advancement.arconia.main.orange_arconium_tree_sapling.title"),
                Component.translatable(
    ...
    AdvancementHolder orangeIngot =
        Advancement.Builder.advancement()
            .addCriterion(
                "orange_arconium_ingot",
                InventoryChangeTrigger.TriggerInstance.hasItems(
    ...
    AdvancementHolder yellowIngot =
        Advancement.Builder.advancement()
            .addCriterion(
                "yellow_arconium_ingot",
                InventoryChangeTrigger.TriggerInstance.hasItems(
    ...
    AdvancementHolder greenIngot =
        Advancement.Builder.advancement()
            .addCriterion(
                "green_arconium_ingot",
                InventoryChangeTrigger.TriggerInstance.hasItems(
    ...
    AdvancementHolder lightBlueIngot =
        Advancement.Builder.advancement()
            .addCriterion(
                "light_blue_arconium_ingot",
                InventoryChangeTrigger.TriggerInstance.hasItems(
    ...
    AdvancementHolder purpleIngot =
        Advancement.Builder.advancement()
            .addCriterion(
                "purple_arconium_ingot",
                InventoryChangeTrigger.TriggerInstance.hasItems(
