...
public class BiomeModifiers extends DatapackBuiltinEntriesProvider {
  ...
  public static final ResourceKey<BiomeModifier> ADD_TREES =
      ResourceKey.create(
  ...
  public static final ResourceKey<BiomeModifier> ADD_CLOVERS =
      ResourceKey.create(
          NeoForgeRegistries.Keys.BIOME_MODIFIERS, // The registry this key is for
    ...
    BUILDER.add(
        ...
        bootstrap -> {
          for (RainbowColor tier : RainbowColor.values()) {
            bootstrap.register(
                ModFeatures.getArconiumTreeConfigured(tier),
                new ConfiguredFeature<>(
                    Feature.TREE,
                    (new TreeConfiguration.TreeConfigurationBuilder(
                            BlockStateProvider.simple(Blocks.OAK_LOG),
                            new StraightTrunkPlacer(5, 2, 0),
                            BlockStateProvider.simple(ModBlocks.getArconiumTreeLeaves(tier).get()),
        ...
        bootstrap -> {
            ...
            bootstrap.register(
                ...
                new PlacedFeature(
                    bootstrap
                        ...
                        .getOrThrow(ModFeatures.getArconiumTreeConfigured(tier)),
                    VegetationPlacements.treePlacement(
                        PlacementUtils.countExtra(0, 0.05F, 1),
                        ModBlocks.getArconiumTreeSapling(tier).get())));
          }
          ...
          bootstrap.register(
              ...
              new PlacedFeature(
                  bootstrap
                      .lookup(Registries.CONFIGURED_FEATURE)
                      .getOrThrow(ModFeatures.CLOVER_PATCH_CONFIGURED),
                  List.of(
                      CountPlacement.of(3),
                      InSquarePlacement.spread(),
                      RandomOffsetPlacement.of(UniformInt.of(-6, 6), UniformInt.of(-3, 3)),
                      PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
                      BiomeFilter.biome(),
                      BlockPredicateFilter.forPredicate(
                          BlockPredicate.matchesBlocks(
                              Direction.DOWN.getUnitVec3i(), Blocks.GRASS_BLOCK)))));
        });
        ...
        bootstrap -> {
          ...
          bootstrap.register(
              ...
              new net.neoforged.neoforge.common.world.BiomeModifiers.AddFeaturesBiomeModifier(
                  forestBiomes,
                  HolderSet.direct(
                      placedFeatures.getOrThrow(ModFeatures.getPlacedTrees(RainbowColor.RED))),
