...
public class ModLanguageProvider extends LanguageProvider {
  ...
  private void registerModItems() {
    ...
    add(
        ModItems.magicInABottle.get().getDescriptionId() + ".tooltip",
        "The Magic Luck-o-Meter indicates it's at %d%%");
  }
  ...
  private void registerAdvancements() {
    Stream.of(
            new String[][] {
              ...
              {
                "advancement.arconia.main.red_tree_branch.desc",
                "Harvest arconium trees for some branches"
              },
              ...
              {
                "advancement.arconia.main.center_pedestal.desc",
                "Craft a center pedestal to perform rituals"
              },
              {"advancement.arconia.main.red_branch_of_essence.title", "Arconium?"},
              {
                "advancement.arconia.main.red_branch_of_essence.desc",
                "Imbue magical properties onto a tree branch"
              },
              ...
              {
                "advancement.arconia.main.red_arconium_essence.desc",
                "Get your first arconium essence"
              },
              {"advancement.arconia.main.red_arconium_ingot.title", "Arconium Ingots"},
              {
                "advancement.arconia.main.red_arconium_ingot.desc",
                "Craft your first arconium ingot"
              },
              {"advancement.arconia.main.orange_arconium_tree_sapling.title", "Orange you glad"},
              {
                "advancement.arconia.main.orange_arconium_tree_sapling.desc",
                "Harvest your first orange arconium sapling"
              },
              {"advancement.arconia.main.orange_arconium_ingot.title", "Not so juicy"},
              {
                "advancement.arconia.main.orange_arconium_ingot.desc",
                "Craft an orange arconium ingot"
              },
              {"advancement.arconia.main.yellow_arconium_ingot.title", "Nautical Nonsense"},
              {
                "advancement.arconia.main.yellow_arconium_ingot.desc",
                "Craft a yellow arconium ingot"
              },
              ...
              {
                "advancement.arconia.main.light_blue_arconium_ingot.title",
                "You smurfed another one!"
              },
              {
                "advancement.arconia.main.light_blue_arconium_ingot.desc",
                "Craft a light blue arconium ingot"
              },
              ...
              {
                "advancement.arconia.main.purple_arconium_ingot.desc",
                "Craft the last, purple arconium ingot"
              },
              {"advancement.arconia.main.touch_grass.title", "Touch Grass"},
              {
                "advancement.arconia.main.touch_grass.desc",
                "Color some grass blocks with tree branches"
              }
            })
  ...
  private void registerMisc() {
    ...
    add(
        "arconia.block.pot_multiblock.set_resource_empty",
        "You either need to use an imbued branch to extract new treasure, or use a plain branch in your main hand and an item in your offhand matching the treasure you do not want the pot to extract anymore");
    add(
        "arconia.block.pot_multiblock.set_resource_full",
        "The pot cannot extract any more treasure");
    add(
        "arconia.block.pot_multiblock.remove_resource_not_found",
        "The item in your offhand is not treasure currently being extracted by the pot");
    add(
        "arconia.block.pot_multiblock.remove_resource_none_set",
        "The pot is not extracting any treasure. If you want to extract new treasure, you will need to imbue your branch using the pedestal ritual");
    add(
        "arconia.block.pot_multiblock.remove_resource_success",
        "The pot will no longer extract %s");

    // pedestal ritual messages
    add(
        "arconia.block.center_pedestal.ritual_start_failed",
        "Failed to start ritual. Perhaps some items are missing?");
    // Pot multiblock
    ...
    // world builder
    add(
        "arconia.block.world_builder.in_progress",
        "The world builder is a little busy right now, please try again later");
    add("arconia.block.world_builder.start_build", "Starting the builder");
    add(
        "arconia.block.world_builder.no_blocks_found",
        "The builder didn't find any blocks to convert");

    // Guide book
    add(
        "arconia.guide_book.landing_text",
        "A collection of notes on my discovery of the secrets to the Leprechaun's wealth, and how to help myself to some of that.");
