...
public class RecipeEntry extends EntryProvider {
  ...
  protected void generatePages() {
    ...
    this.add(
        "test.test.test",
        "Book of Binding: Afrit (Bound)"); // long title to test scaling on recipe 2
    ...
    this.page(
        "smoking",
        () ->
            BookSmokingRecipePageModel.create()
    ...
    this.page(
        "campfire_cooking",
        () ->
            BookCampfireCookingRecipePageModel.create()
                .withRecipeId1("minecraft:cooked_beef_from_campfire_cooking"));

    this.page(
        "stonecutting",
        () ->
            BookStonecuttingRecipePageModel.create()
