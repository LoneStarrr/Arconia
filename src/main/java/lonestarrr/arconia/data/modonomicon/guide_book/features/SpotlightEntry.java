  ...
  protected void generatePages() {
    ...
    this.page(
        ...
        () ->
            BookSpotlightPageModel.create()
                .withText(this.context().pageText())
                // We are using the potion registry here to test and demonstrate using
                // this.registries(). Vanilla potions can be accessed directly without using the
                // resource key, as the Potions class offers potion holders.
                .withItem(
                    new ItemStackTemplate(
                        Items.POTION,
                        DataComponentPatch.builder()
                            .set(
                                ...
                                new PotionContents(
                                    this.registries()
                                        ...
                                        .getOrThrow(Potions.HEALING.unwrapKey().get())))
                            .build())));
        ...
        new ItemStackTemplate(
            ...
            DataComponentPatch.builder()
                .set(
                    ...
                    new BundleContents(List.of(new ItemStackTemplate(Items.APPLE))))
                .build());
    this.page(
        "spotlight5",
        () -> BookSpotlightPageModel.create().withText(this.context().pageText()).withItem(bundle));
