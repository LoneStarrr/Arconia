...
public class AdvancedFormattingEntry extends EntryProvider {
  ...
  protected void generatePages() {
    ...
    this.pageText(
        """
                ...
                *++This is italics underlined++*
                ...
                {1}
                """,
        this.itemLink(Items.DIAMOND), this.itemLink("TestText", Items.EMERALD));
    ...
    this.page("list_test", () -> BookTextPageModel.create().withText(this.context().pageText()));
    ...
    // additional "\\" after the first will add more newlines. Most likely the "\\" must be on a new
    // line each.
    this.pageText(
        """
                Unordered List:
