...
import lonestarrr.arconia.data.modonomicon.guide_book.indexmode.Demo1IndexEntry;
import lonestarrr.arconia.data.modonomicon.guide_book.indexmode.Demo2IndexEntry;
...
public class IndexModeCategory extends CategoryProvider {
  ...
  protected String categoryDescription() {
    return "A category showcasing how Modonomicon works in index mode."; // This is currently only
    // shown for index-mode
    // books
  }
