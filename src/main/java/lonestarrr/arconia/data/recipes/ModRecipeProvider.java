...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        registerColoredBranchRecipes();
        registerArconiumIngotRecipes();
        registerPedestalMisc();
     ...
     */
    private void registerColoredBranchRecipes() {
        ...
        makeImbuedColoredBranch(tier, ModItems.getArconiumEssence(tier).get(), durationTicks, clover, clover,
                Ingredient.of(ModBlocks.getArconiumTreeSapling(tier).get().asItem()), Ingredient.of(RainbowColor.woolByTier(tier)));

        makeImbuedColoredBranch(tier, Items.RED_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.KELP, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.KELP), Ingredient.of(Items.DRIED_KELP_BLOCK), Ingredient.of(Items.DRIED_KELP_BLOCK));
        makeImbuedColoredBranch(tier, Items.APPLE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.APPLE), Ingredient.of(Items.OAK_SAPLING), Ingredient.of(Items.STONE_HOE));

        makeImbuedColoredBranch(tier, Items.SAND, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.SAND), Ingredient.of(Items.SANDSTONE), Ingredient.of(Items.SANDSTONE), Ingredient.of(Items.STONE_SHOVEL));
        makeImbuedColoredBranch(tier, Items.GRAVEL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.GRAVEL), Ingredient.of(Items.FLINT), Ingredient.of(Items.FLINT), Ingredient.of(Items.STONE_SHOVEL));
        makeImbuedColoredBranch(tier, Items.DIRT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.DIRT), Ingredient.of(Items.COARSE_DIRT), Ingredient.of(Items.MUD), Ingredient.of(Items.STONE_SHOVEL));

        makeImbuedColoredBranch(tier, Items.OAK_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.DARK_OAK_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.BIRCH_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.JUNGLE_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.SPRUCE_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.ACACIA_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.MANGROVE_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.ORANGE_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        for (Item item : new Item[]{Items.SUGAR_CANE, Items.WHEAT, Items.PUMPKIN, Items.MELON}) {
            makeImbuedColoredBranch(tier, item, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.RAW_COPPER, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.COAL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.STRING, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.STRING), Ingredient.of(Items.WHITE_WOOL), Ingredient.of(Items.LOOM));
        makeImbuedColoredBranch(tier, Items.MUD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.MUD), Ingredient.of(Items.DIRT), Ingredient.of(Items.GLASS_BOTTLE), Ingredient.of(Items.WATER_BUCKET));
        makeImbuedColoredBranch(tier, Items.CLAY_BALL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.YELLOW_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.SPIDER_EYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.SPIDER_EYE), Ingredient.of(Items.STRING), Ingredient.of(Items.STRING), Ingredient.of(Items.IRON_SWORD));
        makeImbuedColoredBranch(tier, Items.FEATHER, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.CHICKEN), Ingredient.of(Items.EGG), Ingredient.of(Items.FEATHER), Ingredient.of(Items.IRON_SWORD));
        makeImbuedColoredBranch(tier, Items.RAW_IRON, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.LEATHER, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.BONE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.PORKCHOP, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.PORKCHOP), Ingredient.of(Items.PORKCHOP), Ingredient.of(Items.PORKCHOP), Ingredient.of(Items.IRON_SWORD));
        makeImbuedColoredBranch(tier, Items.ROTTEN_FLESH, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.POTATO, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.BEETROOT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.CARROT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.ARROW, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.BONE), Ingredient.of(Items.ARROW), Ingredient.of(Items.SHIELD), Ingredient.of(Items.IRON_SWORD));
        makeImbuedColoredBranch(tier, Items.WHITE_WOOL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.MUTTON), Ingredient.of(Items.WHITE_WOOL), Ingredient.of(Items.BLACK_WOOL), Ingredient.of(Items.SHEARS));

        // Building blocks
        makeImbuedColoredBranch(tier, Items.NETHER_BRICK, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.SOUL_SAND, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.SOUL_SOIL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.BLACKSTONE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.BASALT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.CRIMSON_STEM, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.WARPED_STEM, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.GREEN_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.AMETHYST_SHARD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.RAW_GOLD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.LAPIS_LAZULI, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.REDSTONE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.GUNPOWDER, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.INK_SAC, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.HONEYCOMB, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.HONEY_BOTTLE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.LIGHT_BLUE_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.PRISMARINE_SHARD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.PRISMARINE_CRYSTALS, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.OBSIDIAN, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.SLIME_BALL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.EMERALD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.END_STONE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.CHORUS_FRUIT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.CHORUS_FRUIT), Ingredient.of(Items.CHORUS_FLOWER), Ingredient.of(Items.END_STONE));
        makeImbuedColoredBranch(tier, Items.ENDER_PEARL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.EXPERIENCE_BOTTLE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.BLUE_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.NETHER_WART, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.NETHER_WART), Ingredient.of(Items.RED_NETHER_BRICKS), Ingredient.of(Items.NETHER_WART_BLOCK));
        makeImbuedColoredBranch(tier, Items.WITHER_SKELETON_SKULL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.WITHER_SKELETON_SKULL), Ingredient.of(Items.SOUL_SAND), Ingredient.of(Items.WITHER_ROSE));
        makeImbuedColoredBranch(tier, Items.BLAZE_ROD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.DIAMOND, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.ECHO_SHARD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.PURPLE_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.NETHER_STAR, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(tier, Items.SHULKER_SHELL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.SHULKER_SHELL), Ingredient.of(Items.PURPLE_SHULKER_BOX), Ingredient.of(Items.NETHERITE_SWORD));
        makeImbuedColoredBranch(tier, Items.GHAST_TEAR, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.GHAST_TEAR), Ingredient.of(Items.END_CRYSTAL), Ingredient.of(Items.NETHERITE_SWORD));
        makeImbuedColoredBranch(tier, Items.ANCIENT_DEBRIS, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.ANCIENT_DEBRIS), Ingredient.of(Items.NETHERITE_INGOT), Ingredient.of(Items.NETHERITE_HOE));
    }

    private void registerArconiumIngotRecipes() {
    ...
    private void registerPedestalMisc() {
    }

    private void registerVanillaMisc() {
        this.shaped(RecipeCategory.MISC, ModItems.cloverStaff.get())
        ...
        this.shaped(RecipeCategory.MISC, ModBlocks.centerPedestal.get())
        ...
        this.shaped(RecipeCategory.MISC, ModBlocks.pedestal.get())
        ...
        this.shapeless(RecipeCategory.MISC, Items.GREEN_DYE, 1)
                .requires(ModItems.threeLeafClover)
                .unlockedBy("has_item", has(Items.STICK)) //unlockedBy is required, URGH
                .save(output);

//        this.shapeless(RecipeCategory.MISC, )
        // Disabled for now, still available in creative for toying around with
//        this.shaped(RecipeCategory.MISC, ModBlocks.worldBuilder.get())
//                .define('D', Items.DIRT)
...
//                .save(output);
    ...
    private void registerArconiumIngots() {
        for (RainbowColor tier : RainbowColor.values()) {
            ...
            this.shapeless(RecipeCategory.MISC, ingot, 9)
    ...
    private void registerArconiumSickles() {
        for (RainbowColor tier : RainbowColor.values()) {
            ...
            this.shaped(RecipeCategory.TOOLS, sickle)
                    .define('S', Items.STICK)
                    .define('I', ingot)
                    .pattern("III")
                    .pattern("I I")
    ...
    private void registerArconiumBlocks() {
        for (RainbowColor tier : RainbowColor.values()) {
            ...
            Item ingot = ModItems.getArconiumIngot(tier).get();
            this.shaped(RecipeCategory.MISC, block)
                    .define('I', ingot)
                    .pattern("III")
                    .pattern("III")
                    .pattern("III")
