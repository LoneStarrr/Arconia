...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(@NotNull RecipeOutput output) {
        ...
        registerColoredBranchRecipes(output);
    ...
    /*
     * Recipes for colored branchess with nbt data on them indicating what item will be generated by the mod's resource generator
     */
    private void registerColoredBranchRecipes(RecipeOutput output) {
        ...
        makeImbuedColoredBranch(output, tier, ModItems.getArconiumEssence(tier).get(), durationTicks, clover, clover,
                Ingredient.of(ModBlocks.getArconiumTreeSapling(tier).get().asItem()), Ingredient.of(RainbowColor.woolByTier(tier)));

        makeImbuedColoredBranch(output, tier, Items.RED_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.KELP, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.KELP), Ingredient.of(Items.DRIED_KELP_BLOCK), Ingredient.of(Items.DRIED_KELP_BLOCK));
        makeImbuedColoredBranch(output, tier, Items.APPLE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.APPLE), Ingredient.of(Items.OAK_SAPLING), Ingredient.of(Items.STONE_HOE));

        makeImbuedColoredBranch(output, tier, Items.SAND, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.SAND), Ingredient.of(Items.SANDSTONE), Ingredient.of(Items.SANDSTONE), Ingredient.of(Items.STONE_SHOVEL));
        makeImbuedColoredBranch(output, tier, Items.GRAVEL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.GRAVEL), Ingredient.of(Items.FLINT), Ingredient.of(Items.FLINT), Ingredient.of(Items.STONE_SHOVEL));
        makeImbuedColoredBranch(output, tier, Items.DIRT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.DIRT), Ingredient.of(Items.COARSE_DIRT), Ingredient.of(Items.MUD), Ingredient.of(Items.STONE_SHOVEL));

        makeImbuedColoredBranch(output, tier, Items.OAK_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.DARK_OAK_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.BIRCH_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.JUNGLE_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.SPRUCE_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.ACACIA_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.MANGROVE_LOG, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.ORANGE_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        for (Item item : new Item[]{Items.SUGAR_CANE, Items.WHEAT, Items.PUMPKIN, Items.MELON}) {
            makeImbuedColoredBranch(output, tier, item, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.RAW_COPPER, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.COAL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.STRING, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.STRING), Ingredient.of(Items.WHITE_WOOL), Ingredient.of(Items.LOOM));
        makeImbuedColoredBranch(output, tier, Items.MUD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.MUD), Ingredient.of(Items.DIRT), Ingredient.of(Items.GLASS_BOTTLE), Ingredient.of(Items.WATER_BUCKET));
        makeImbuedColoredBranch(output, tier, Items.CLAY_BALL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.YELLOW_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.SPIDER_EYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.SPIDER_EYE), Ingredient.of(Items.STRING), Ingredient.of(Items.STRING), Ingredient.of(Items.IRON_SWORD));
        makeImbuedColoredBranch(output, tier, Items.FEATHER, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.CHICKEN), Ingredient.of(Items.EGG), Ingredient.of(Items.FEATHER), Ingredient.of(Items.IRON_SWORD));
        makeImbuedColoredBranch(output, tier, Items.RAW_IRON, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.LEATHER, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.BONE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.PORKCHOP, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.PORKCHOP), Ingredient.of(Items.PORKCHOP), Ingredient.of(Items.PORKCHOP), Ingredient.of(Items.IRON_SWORD));
        makeImbuedColoredBranch(output, tier, Items.ROTTEN_FLESH, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.POTATO, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.BEETROOT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.CARROT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.ARROW, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.BONE), Ingredient.of(Items.ARROW), Ingredient.of(Items.SHIELD), Ingredient.of(Items.IRON_SWORD));
        makeImbuedColoredBranch(output, tier, Items.WHITE_WOOL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.MUTTON), Ingredient.of(Items.WHITE_WOOL), Ingredient.of(Items.BLACK_WOOL), Ingredient.of(Items.SHEARS));

        // Building blocks
        makeImbuedColoredBranch(output, tier, Items.NETHER_BRICK, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.SOUL_SAND, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.SOUL_SOIL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.BLACKSTONE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.BASALT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.CRIMSON_STEM, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.WARPED_STEM, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.GREEN_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.AMETHYST_SHARD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.RAW_GOLD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.LAPIS_LAZULI, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.REDSTONE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.GUNPOWDER, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.INK_SAC, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.HONEYCOMB, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.HONEY_BOTTLE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.LIGHT_BLUE_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.PRISMARINE_SHARD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.PRISMARINE_CRYSTALS, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.OBSIDIAN, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.SLIME_BALL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.EMERALD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.END_STONE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.CHORUS_FRUIT, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.CHORUS_FRUIT), Ingredient.of(Items.CHORUS_FLOWER), Ingredient.of(Items.END_STONE));
        makeImbuedColoredBranch(output, tier, Items.ENDER_PEARL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.EXPERIENCE_BOTTLE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.BLUE_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.NETHER_WART, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.NETHER_WART), Ingredient.of(Items.RED_NETHER_BRICKS), Ingredient.of(Items.NETHER_WART_BLOCK));
        makeImbuedColoredBranch(output, tier, Items.WITHER_SKELETON_SKULL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.WITHER_SKELETON_SKULL), Ingredient.of(Items.SOUL_SAND), Ingredient.of(Items.WITHER_ROSE));
        makeImbuedColoredBranch(output, tier, Items.BLAZE_ROD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.DIAMOND, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.ECHO_SHARD, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.PURPLE_DYE, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.NETHER_STAR, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
        ...
        makeImbuedColoredBranch(output, tier, Items.SHULKER_SHELL, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.SHULKER_SHELL), Ingredient.of(Items.PURPLE_SHULKER_BOX), Ingredient.of(Items.NETHERITE_SWORD));
        makeImbuedColoredBranch(output, tier, Items.GHAST_TEAR, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
                Ingredient.of(Items.GHAST_TEAR), Ingredient.of(Items.END_CRYSTAL), Ingredient.of(Items.NETHERITE_SWORD));
        makeImbuedColoredBranch(output, tier, Items.ANCIENT_DEBRIS, durationTicks, Ingredient.of(ModItems.getArconiumIngot(tier).get()), clover,
...
//                .save(output);
    ...
    /**
     * Craft an imbued colored branch for a given item to be generated as part of the resource generation of the mod
     *
     * @param recipeOutput
     * @param tier          Tier of colored branch to make
     ...
     * @param ingredients
     */
    private static void makeImbuedColoredBranch(
        ...
        ResourceLocation id = imbuedBranchId(tier, resourceItem);
        recipeOutput.accept(id, new PedestalRecipe(coloredBranch, durationTicks, newIngredients), null);
    }
