...
public class BranchItemRenderer implements SpecialModelRenderer<ItemStack> {
  public static final Identifier ID =
      Identifier.fromNamespaceAndPath(Arconia.MOD_ID, "branch_overlay");
  ...
  public void submit(
    ...
    minecraft
        ...
        .updateForTopItem(state, contained, ItemDisplayContext.GUI, minecraft.level, null, 0);
    poseStack.pushPose();
