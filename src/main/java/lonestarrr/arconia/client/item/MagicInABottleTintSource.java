...
/**
 * Per-stack tint source for the magic-in-a-bottle overlay layer — picks the colour from the bottle's
 * stored tier (the {@code MagicInABottleData} component) so the swirl matches whichever rainbow tier
