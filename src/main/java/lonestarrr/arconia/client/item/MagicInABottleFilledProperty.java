...
/**
 * Exposes {@link MagicInABottle#getFilledPercentage} (a 0..1 ratio of ticks elapsed vs. ticks needed
 * for the next loot roll) to the data-driven item-model system, so the bottle's ClientItem JSON can
