...
/**
 * All the colors of the Minecraft rainbow roughly matching dye colors - used by various blocks and
 * items
 */
public enum RainbowColor implements StringRepresentable {
  ...
  private RainbowColor(
      int tier, @Nonnull String name, @Nonnull String unlocalizedName, int colorValue) {
    this.tier = tier;
    this.tierName = name;
