...
public class PatchouliHelper {
  public static final String GUIDE_BOOK_ID =
      Identifier.fromNamespaceAndPath(Arconia.MOD_ID, "guide_book")
          .toString(); // Also hardcoded in advancement icon
  public static final Identifier PATCHOULI_GUIDE_BOOK =
    ...
    if (dct != null) {
      ...
      patch =
          DataComponentPatch.builder()
              .set(dctRloc, ResourceLocationHelper.prefix("guide_book"))
              .build();
    }
