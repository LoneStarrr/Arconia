...
public class InventoryHelper {
    ...
    @Nullable
    public static ResourceHandler<ItemResource> getInventory(Level level, BlockPos pos, Direction direction) {
     ...
     * @param dest
     * @param stack
     * @param simulate If set, no items will actually be transferred, but the return value represents what would happen
     * @return Empty itemstack if all items could be inserted or there were none to insert, otherwise items that would not fit.
     */
    @Nonnull
    public static ItemStack insertItem(ResourceHandler<ItemResource> dest, @Nonnull ItemStack stack, boolean simulate)
    {
