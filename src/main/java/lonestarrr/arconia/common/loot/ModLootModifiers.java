...
public class ModLootModifiers {
    ...
    public static final DeferredRegister<MapCodec<? extends LootItemCondition>> LOOT_CONDITION_TYPES = DeferredRegister.create(BuiltInRegistries.LOOT_CONDITION_TYPE, Arconia.MOD_ID);

    public static final Supplier<MapCodec<DirtLootModifier>> DIRT_MODIFIER = CODECS.register("dirt", () -> DirtLootModifier.CODEC);
    public static final Supplier<MapCodec<PlayerNeedsGuideBook>> NEEDS_GUIDEBOOK = LOOT_CONDITION_TYPES.register("player_needs_guidebook", () -> PlayerNeedsGuideBook.CODEC);
}
