 ...
 * and on /reload. The vanilla 1.21.4 client only receives recipe display data, so JEI has no way to
 * enumerate {@link lonestarrr.arconia.common.crafting.PedestalRecipe} without this opt-in.
 */
